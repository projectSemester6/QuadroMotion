...
public class KeyBoardCommands extends JFrame implements KeyListener {
	...
	public KeyBoardCommands(JRadioButton[] config) {
		...
		this.addFocusListener(new FocusListener() {
			...
			public void focusGained(FocusEvent e) {
				if (controller.getControlState().equals("LANDED"))
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_SPACE:
			if (controller.getControlState().equals("HOVERING") || controller.getControlState().equals("FLYING")) {
				controller.setPilotingState(PilotingStates.STATE_7_LANDING);
				System.out.println("land");
			}
			break;
		case KeyEvent.VK_LEFT:
			if (controller.getControlState().equals("HOVERING")) {
